...
func main() {
	urls := []string{
		...
		"https://go-mod-viewer.appspot.com/github.com/trustbloc/kms-go@v1.1.2/crypto/tinkcrypto/wrap_support.go#L205",
		"https://go-mod-viewer.appspot.com/github.com/trustbloc/kms-go@v1.1.2/crypto/tinkcrypto/wrap_support.go#L332",
		"https://go-mod-viewer.appspot.com/github.com/trustbloc/kms-go@v1.1.2/doc/jose/jwk/jwk.go#L566",
		"https://go-mod-viewer.appspot.com/github.com/trustbloc/kms-go@v1.1.2/doc/util/jwkkid/kid_creator.go#L149",
		"https://go-mod-viewer.appspot.com/github.com/trustbloc/kms-go@v1.1.2/doc/util/jwkkid/kid_creator.go#L219",
		"https://go-mod-viewer.appspot.com/github.com/trustbloc/kms-go@v1.1.2/doc/util/jwkkid/kid_creator.go#L240",
		"https://go-mod-viewer.appspot.com/github.com/trustbloc/kms-go@v1.1.2/doc/util/jwkkid/kid_creator_test.go#L331",
		"https://go-mod-viewer.appspot.com/github.com/tsingson/goflatbuffers@v0.0.0-20200425094158-ed9a05ac061e/pool_test/testcase/pool_test.go#L207",
		"https://go-mod-viewer.appspot.com/github.com/tuneinsight/lattigo/v3@v3.0.5/bfv/polynomial_evaluation.go#L180",
		"https://go-mod-viewer.appspot.com/github.com/tuneinsight/lattigo/v3@v3.0.5/ckks/ciphertext.go#L87",
		"https://go-mod-viewer.appspot.com/github.com/tuneinsight/lattigo/v3@v3.0.5/ckks/polynomial_evaluation.go#L348",
		"https://go-mod-viewer.appspot.com/github.com/tuneinsight/lattigo/v3@v3.0.5/dckks/transform.go#L71",
		"https://go-mod-viewer.appspot.com/github.com/tuneinsight/lattigo/v4@v4.1.0/bfv/polynomial_evaluation.go#L180",
		"https://go-mod-viewer.appspot.com/github.com/tuneinsight/lattigo/v4@v4.1.0/bgv/polynomial_evaluation.go#L268",
		"https://go-mod-viewer.appspot.com/github.com/tuneinsight/lattigo/v4@v4.1.0/ckks/polynomial_evaluation.go#L354",
		"https://go-mod-viewer.appspot.com/github.com/tuneinsight/lattigo/v4@v4.1.0/dbgv/transform.go#L68",
		"https://go-mod-viewer.appspot.com/github.com/tuneinsight/lattigo/v4@v4.1.0/dckks/transform.go#L100",
		"https://go-mod-viewer.appspot.com/github.com/turingchain2020/turingchain@v1.1.21/wallet/bipwallet/basen/basen.go#L122",
		"https://go-mod-viewer.appspot.com/github.com/turingchain2020/turingchain@v1.1.21/wallet/bipwallet/go-bip32/utils.go#L97",
		"https://go-mod-viewer.appspot.com/github.com/turingchain2020/turingchain@v1.1.21/wallet/bipwallet/go-bip39/bip39.go#L222",
		"https://go-mod-viewer.appspot.com/github.com/tv42/zbase32@v0.0.0-20220222190657-f76a9fc892fa/cmd/zbase32-encode/encode.go#L44",
		"https://go-mod-viewer.appspot.com/github.com/tyler-smith/go-bip32@v1.0.0/utils.go#L124",
		"https://go-mod-viewer.appspot.com/github.com/u-root/u-root@v0.14.0/pkg/boot/ebda/ebda_test.go#L47",
		"https://go-mod-viewer.appspot.com/github.com/u-root/u-root@v0.14.0/pkg/boot/multiboot/header.go#L92",
		"https://go-mod-viewer.appspot.com/github.com/u-root/u-root@v0.14.0/pkg/hsskey/filereader_test.go#L60",
		"https://go-mod-viewer.appspot.com/github.com/unchainio/pkg@v0.22.1-0.20191007153834-34f39e811e33/xutil/xutil.go#L19",
		"https://go-mod-viewer.appspot.com/github.com/unidoc/unipdf/v3@v3.63.0/model/model.go#L1412",
		"https://go-mod-viewer.appspot.com/github.com/unixpickle/model3d@v0.4.4/toolbox3d/rect_set.go#L280",
		"https://go-mod-viewer.appspot.com/github.com/unknwon/com@v1.0.1/string.go#L43",
		"https://go-mod-viewer.appspot.com/github.com/urfave/cli/v2@v2.27.5/errors.go#L43",
		"https://go-mod-viewer.appspot.com/github.com/urionz/goutil@v0.4.3/strutil/strutil.go#L185",
		"https://go-mod-viewer.appspot.com/github.com/v2fly/v2ray-core/v5@v5.21.0/transport/internet/headers/http/http_test.go#L62",
		"https://go-mod-viewer.appspot.com/github.com/vadv/gopher-lua-libs@v0.5.0/stats/api.go#L14",
		"https://go-mod-viewer.appspot.com/github.com/valhallacoin/vhcd@v0.0.0-20200309193211-93baf50d5e41/blockchain/stake/internal/ticketdb/chainio.go#L253",
		"https://go-mod-viewer.appspot.com/github.com/vapor-ware/synse-sdk@v0.1.0-alpha.0.20220721214717-2488347bfe15/sdk/server.go#L517",
		"https://go-mod-viewer.appspot.com/github.com/vela-ssoc/backend-common@v0.0.0-20230519120119-78d1183fd0db/opencond/state.go#L72",
		"https://go-mod-viewer.appspot.com/github.com/venarius/bitfinex-api-go@v0.0.0-20221121132050-cedc2d2965d9/v2/rest/currencies.go#L40",
		"https://go-mod-viewer.appspot.com/github.com/vishvananda/netlink@v1.3.0/route_linux.go#L152",
		"https://go-mod-viewer.appspot.com/github.com/vishvananda/netlink@v1.3.0/route_linux.go#L226",
		"https://go-mod-viewer.appspot.com/github.com/vishvananda/netlink@v1.3.0/route_linux.go#L341",
		"https://go-mod-viewer.appspot.com/github.com/vishvananda/netlink@v1.3.0/route_linux.go#L350",
		"https://go-mod-viewer.appspot.com/github.com/vishvananda/netlink@v1.3.0/route_linux.go#L364",
		"https://go-mod-viewer.appspot.com/github.com/vishvananda/netlink@v1.3.0/route_linux.go#L376",
		"https://go-mod-viewer.appspot.com/github.com/vishvananda/netlink@v1.3.0/route_linux.go#L685",
		"https://go-mod-viewer.appspot.com/github.com/vishvananda/netlink@v1.3.0/route_linux.go#L691",
		"https://go-mod-viewer.appspot.com/github.com/vitrun/qart@v0.0.0-20160531060029-bf64b92db6b0/coding/coding.go#L694",
		"https://go-mod-viewer.appspot.com/github.com/vivint/infectious@v0.0.0-20200605153912-25a574ae18a3/berlekamp_welch_test.go#L81",
		"https://go-mod-viewer.appspot.com/github.com/vmware/go-ipfix@v0.11.0/pkg/kafka/producer/kafka.go#L170",
		"https://go-mod-viewer.appspot.com/github.com/vmware/go-nfs-client@v0.0.0-20190605212624-d43b92724c1b/nfs/rpc/tcp.go#L51",
		"https://go-mod-viewer.appspot.com/github.com/vmware/vsphere-automation-sdk-go/runtime@v0.7.0/common/helpers.go#L21",
		"https://go-mod-viewer.appspot.com/github.com/vmware/vsphere-automation-sdk-go/runtime@v0.7.0/provider/introspection/LocalProviderIntrospector.go#L74",
		"https://go-mod-viewer.appspot.com/github.com/volatiletech/sqlboiler/v4@v4.16.2/types/array.go#L91",
		"https://go-mod-viewer.appspot.com/github.com/volvo-cars/lingon@v0.0.0-20230928083259-862afa6549f0/cmd/tools/filtersb/cli.go#L141",
		"https://go-mod-viewer.appspot.com/github.com/wagoodman/go-progress@v0.0.0-20230925121702-07e42b3cdba0/stream.go#L62",
		"https://go-mod-viewer.appspot.com/github.com/waldiirawan/apm-agent-go/v2@v2.2.2/stacktrace/stacktrace.go#L45",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/container/gmap/gmap_z_example_any_any_test.go#L406",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/container/gmap/gmap_z_example_int_any_test.go#L406",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/container/gmap/gmap_z_example_int_int_test.go#L334",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/container/gmap/gmap_z_example_list_test.go#L445",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/container/gmap/gmap_z_example_str_any_test.go#L403",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/container/gmap/gmap_z_example_str_int_test.go#L331",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/container/gmap/gmap_z_example_str_str_test.go#L332",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/container/gtree/gtree_z_example_avltree_test.go#L276",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/container/gtree/gtree_z_example_btree_test.go#L276",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/container/gtree/gtree_z_example_redblacktree_test.go#L291",
		"https://go-mod-viewer.appspot.com/github.com/wangyougui/gf/v2@v2.6.5/net/gtcp/gtcp_conn.go#L120",
		"https://go-mod-viewer.appspot.com/github.com/wasmcloud/actor-tinygo@v0.1.4/core.go#L134",
		"https://go-mod-viewer.appspot.com/github.com/wasmcloud/actor-tinygo@v0.1.4/core.go#L169",
		"https://go-mod-viewer.appspot.com/github.com/wasmcloud/actor-tinygo@v0.1.4/core.go#L33",
		"https://go-mod-viewer.appspot.com/github.com/wasmcloud/actor-tinygo@v0.1.4/core.go#L68",
		"https://go-mod-viewer.appspot.com/github.com/wasmcloud/actor-tinygo@v0.1.4/model.go#L121",
		"https://go-mod-viewer.appspot.com/github.com/wasmcloud/actor-tinygo@v0.1.4/model.go#L86",
		"https://go-mod-viewer.appspot.com/github.com/wavesplatform/gowaves@v0.10.6/cmd/wallet/main.go#L208",
		"https://go-mod-viewer.appspot.com/github.com/wavesplatform/gowaves@v0.10.6/pkg/crypto/messaging_test.go#L229",
		"https://go-mod-viewer.appspot.com/github.com/wavesplatform/gowaves@v0.10.6/pkg/proto/proto.go#L1828",
		"https://go-mod-viewer.appspot.com/github.com/wavesplatform/gowaves@v0.10.6/pkg/proto/proto.go#L1924",
		"https://go-mod-viewer.appspot.com/github.com/wavesplatform/gowaves@v0.10.6/pkg/proto/transactions_test.go#L4830",
		"https://go-mod-viewer.appspot.com/github.com/wavesplatform/gowaves@v0.10.6/pkg/proto/transactions_test.go#L6081",
		"https://go-mod-viewer.appspot.com/github.com/weaveworks/mesh@v0.0.0-20191105120815-58dbcc3e8e63/gossip_test.go#L239",
		"https://go-mod-viewer.appspot.com/github.com/weaviate/weaviate@v1.27.0/adapters/repos/db/index.go#L840",
		"https://go-mod-viewer.appspot.com/github.com/webability-go/xdominion@v0.5.1/xtable.go#L428",
		"https://go-mod-viewer.appspot.com/github.com/wechaty/go-wechaty@v0.4.12/wechaty-puppet/events/events.go#L128",
		"https://go-mod-viewer.appspot.com/github.com/wenqiq/vsphere-automation-sdk-go/runtime@v0.7.2/common/helpers.go#L21",
		"https://go-mod-viewer.appspot.com/github.com/wenqiq/vsphere-automation-sdk-go/runtime@v0.7.2/provider/introspection/LocalProviderIntrospector.go#L74",
		"https://go-mod-viewer.appspot.com/github.com/why444216978/go-util@v1.0.31/xhop/xhop.go#L260",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/container/gmap/gmap_z_example_any_any_test.go#L406",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/container/gmap/gmap_z_example_int_any_test.go#L406",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/container/gmap/gmap_z_example_int_int_test.go#L334",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/container/gmap/gmap_z_example_list_test.go#L445",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/container/gmap/gmap_z_example_str_any_test.go#L403",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/container/gmap/gmap_z_example_str_int_test.go#L331",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/container/gmap/gmap_z_example_str_str_test.go#L332",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/container/gtree/gtree_z_example_avltree_test.go#L276",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/container/gtree/gtree_z_example_btree_test.go#L276",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/container/gtree/gtree_z_example_redblacktree_test.go#L291",
		"https://go-mod-viewer.appspot.com/github.com/wowqhb/gf/v2@v2.0.0-20230307100035-bbb9e3c9173d/net/gtcp/gtcp_conn.go#L120",
		"https://go-mod-viewer.appspot.com/github.com/writeas/web-core@v1.6.0/data/data.go#L41",
		"https://go-mod-viewer.appspot.com/github.com/xiaotianfork/q-tls-common@v0.1.4/sm4/sm4_gcm.go#L145",
		"https://go-mod-viewer.appspot.com/github.com/xiaotianfork/q-tls-common@v0.1.4/sm4/sm4_gcm.go#L157",
		"https://go-mod-viewer.appspot.com/github.com/xlab/at@v0.0.0-20240804190732-c1b18c698ca6/pdu/7bit.go#L100",
		"https://go-mod-viewer.appspot.com/github.com/xochat/xochat_im_server_lib@v1.0.5/pkg/util/decimal.go#L856",
		"https://go-mod-viewer.appspot.com/github.com/xssnick/tonutils-go@v1.10.2/adnl/packet.go#L182",
		"https://go-mod-viewer.appspot.com/github.com/xssnick/tonutils-go@v1.10.2/tl/loader.go#L63",
		"https://go-mod-viewer.appspot.com/github.com/xtls/xray-core@v1.8.24/transport/internet/headers/http/http_test.go#L62",
		"https://go-mod-viewer.appspot.com/github.com/xuender/oils@v1.0.51/cryptos/encrypt.go#L54",
		"https://go-mod-viewer.appspot.com/github.com/xuperchain/crypto@v0.0.0-20230728040913-ea9045636ba9/common/utils/bytes.go#L35",
		"https://go-mod-viewer.appspot.com/github.com/xuri/excelize/v2@v2.9.0/crypt.go#L175",
		"https://go-mod-viewer.appspot.com/github.com/xxjwxc/public@v0.0.0-20241023074655-99f8488f895c/mytriton/triton.go#L153",
		"https://go-mod-viewer.appspot.com/github.com/xxjwxc/public@v0.0.0-20241023074655-99f8488f895c/mytriton/triton.go#L61",
		"https://go-mod-viewer.appspot.com/github.com/yandex/pandora@v0.5.32/components/providers/scenario/http/postprocessor/var_header.go#L18",
		"https://go-mod-viewer.appspot.com/github.com/yandex/pandora@v0.5.32/components/providers/scenario/http/postprocessor/var_jsonpath.go#L18",
		"https://go-mod-viewer.appspot.com/github.com/yandex/pandora@v0.5.32/components/providers/scenario/http/postprocessor/var_xpath.go#L17",
		"https://go-mod-viewer.appspot.com/github.com/ystia/yorc/v4@v4.3.0/deployments/store/definition_store.go#L171",
		"https://go-mod-viewer.appspot.com/github.com/ystia/yorc/v4@v4.3.0/storage/store_mgr.go#L203",
		"https://go-mod-viewer.appspot.com/github.com/zaquestion/lab@v0.25.1/cmd/label_list.go#L73",
		"https://go-mod-viewer.appspot.com/github.com/zaquestion/lab@v0.25.1/cmd/mr_edit.go#L380",
		"https://go-mod-viewer.appspot.com/github.com/zbliujia/go-libp2p@v0.31.6/p2p/net/swarm/dial_error.go#L56",
		"https://go-mod-viewer.appspot.com/github.com/zgs0103/gmsm@v1.4.7/sm4/sm4_gcm.go#L156",
		"https://go-mod-viewer.appspot.com/github.com/zgs0103/gmsm@v1.4.7/sm4/sm4_gcm.go#L168",
		"https://go-mod-viewer.appspot.com/github.com/zhengxiexie/vsphere-automation-sdk-go/runtime@v0.7.2/common/helpers.go#L21",
		"https://go-mod-viewer.appspot.com/github.com/zhengxiexie/vsphere-automation-sdk-go/runtime@v0.7.2/provider/introspection/LocalProviderIntrospector.go#L74",
		"https://go-mod-viewer.appspot.com/github.com/zhufuyi/pkg@v1.4.1/encoding/encoding_test.go#L197",
		"https://go-mod-viewer.appspot.com/github.com/zhufuyi/sponge@v1.10.2/pkg/encoding/encoding_test.go#L197",
		"https://go-mod-viewer.appspot.com/github.com/zitadel/oidc/v2@v2.12.2/example/server/storage/oidc.go#L109",
		"https://go-mod-viewer.appspot.com/github.com/zitadel/oidc@v1.13.5/example/server/storage/oidc.go#L107",
		"https://go-mod-viewer.appspot.com/gitlab.com/aquachain/aquachain@v1.7.15/p2p/rlpx.go#L464",
		"https://go-mod-viewer.appspot.com/gitlab.com/aquachain/aquachain@v1.7.15/p2p/rlpx.go#L476",
		"https://go-mod-viewer.appspot.com/gitlab.com/bboehmke/sunny@v0.16.0/proto/sma_net2.go#L49",
		"https://go-mod-viewer.appspot.com/gitlab.com/elixxir/crypto@v0.0.9/contact/contact.go#L158",
		"https://go-mod-viewer.appspot.com/gitlab.com/elixxir/crypto@v0.0.9/e2e/aes.go#L170",
		"https://go-mod-viewer.appspot.com/gitlab.com/elixxir/crypto@v0.0.9/indexedDb/database_test.go#L216",
		"https://go-mod-viewer.appspot.com/gitlab.com/elixxir/crypto@v0.0.9/indexedDb/database_test.go#L241",
		"https://go-mod-viewer.appspot.com/gitlab.com/elixxir/crypto@v0.0.9/rsa/public.go#L92",
		"https://go-mod-viewer.appspot.com/gitlab.com/evatix-go/core@v1.3.55/coredata/corestr/NonChainedLinkedCollectionNodes.go#L108",
		"https://go-mod-viewer.appspot.com/gitlab.com/evatix-go/core@v1.3.55/coredata/corestr/NonChainedLinkedListNodes.go#L108",
		"https://go-mod-viewer.appspot.com/gitlab.com/evatix-go/core@v1.3.55/corevalidator/SimpleSliceRangeValidator.go#L27",
		"https://go-mod-viewer.appspot.com/gitlab.com/mergetb/tech/rtnl@v0.1.14/veth.go#L46",
		"https://go-mod-viewer.appspot.com/gitlab.com/xx_network/crypto@v0.0.6/large/int.go#L357",
		"https://go-mod-viewer.appspot.com/gitlab.com/xx_network/crypto@v0.0.6/signature/rsa/rsa.go#L149",
		"https://go-mod-viewer.appspot.com/gitlab.dms3.io/p2p/go-buffer-pool@v0.0.1/pool_test.go#L180",
		"https://go-mod-viewer.appspot.com/gnorm.org/gnorm@v1.1.1/database/drivers/mysql/gnorm/db.go#L114",
		"https://go-mod-viewer.appspot.com/gnorm.org/gnorm@v1.1.1/database/drivers/postgres/gnorm/db.go#L116",
		"https://go-mod-viewer.appspot.com/go.chromium.org/luci@v0.0.0-20241023165946-7e5df5c0bee9/cv/internal/gerrit/metadata/metadata.go#L35",
		"https://go-mod-viewer.appspot.com/go.chromium.org/luci@v0.0.0-20241023165946-7e5df5c0bee9/cv/internal/gerrit/poller/partition.go#L83",
		"https://go-mod-viewer.appspot.com/go.chromium.org/luci@v0.0.0-20241023165946-7e5df5c0bee9/gae/impl/memory/datastore_index_selection.go#L345",
		"https://go-mod-viewer.appspot.com/go.chromium.org/luci@v0.0.0-20241023165946-7e5df5c0bee9/led/job/info_buildbucket.go#L121",
		"https://go-mod-viewer.appspot.com/go.dedis.ch/cothority/v3@v3.4.9/evoting/lib/chains.go#L92",
		"https://go-mod-viewer.appspot.com/go.dedis.ch/cothority/v3@v3.4.9/evoting/service/service.go#L780",
		"https://go-mod-viewer.appspot.com/go.dedis.ch/dela@v0.1.0/cli/node/builder.go#L109",
		"https://go-mod-viewer.appspot.com/go.dedis.ch/dela@v0.1.0/core/ordering/cosipbft/pbft/view.go#L93",
		"https://go-mod-viewer.appspot.com/go.elastic.co/apm/v2@v2.6.2/stacktrace/stacktrace.go#L45",
		"https://go-mod-viewer.appspot.com/go.elastic.co/apm@v1.15.0/stacktrace/stacktrace.go#L45",
		"https://go-mod-viewer.appspot.com/go.opencensus.io@v0.24.0/examples/gauges/gauge.go#L86",
		"https://go-mod-viewer.appspot.com/go.sia.tech/siad@v1.5.9/modules/host/mdm/instructionreadregistry_test.go#L74",
		"https://go-mod-viewer.appspot.com/go.sia.tech/siad@v1.5.9/modules/host/mdm/instructionupdateregistry.go#L111",
		"https://go-mod-viewer.appspot.com/go.sia.tech/siad@v1.5.9/modules/host/mdm/instructionupdateregistry_test.go#L154",
		"https://go-mod-viewer.appspot.com/go.skia.org/infra@v0.0.0-20241023041518-955d0cdc4394/autoroll/go/repo_manager/parent/pre_upload_steps.go#L510",
		"https://go-mod-viewer.appspot.com/go.skia.org/infra@v0.0.0-20241023041518-955d0cdc4394/skolo/go/encrypt_ultravnc_password/encrypt_ultravnc_password.go#L47",
		"https://go-mod-viewer.appspot.com/go.uber.org/zap@v1.27.0/buffer/buffer_test.go#L74",
		"https://go-mod-viewer.appspot.com/go.vocdoni.io/dvote@v1.10.1/vochain/state/sik.go#L431",
		"https://go-mod-viewer.appspot.com/go.vocdoni.io/dvote@v1.10.1/vochain/state/utils.go#L55",
		"https://go-mod-viewer.appspot.com/golang.org/x/exp@v0.0.0-20240904232852-e7e105dedf7e/slices/slices_test.go#L1058",
		"https://go-mod-viewer.appspot.com/golang.org/x/exp@v0.0.0-20240904232852-e7e105dedf7e/slices/slices_test.go#L515",
		"https://go-mod-viewer.appspot.com/golang.org/x/perf@v0.0.0-20240910214617-f1a715d501dd/cmd/benchstat/internal/benchtab/table.go#L326",
		"https://go-mod-viewer.appspot.com/golang.zx2c4.com/wireguard/wgctrl@v0.0.0-20230429144221-925a1e7659e6/internal/wglinux/client_linux_test.go#L174",
		"https://go-mod-viewer.appspot.com/google.golang.org/grpc@v1.67.1/credentials/alts/internal/conn/record_test.go#L309",
		"https://go-mod-viewer.appspot.com/google.golang.org/grpc@v1.67.1/encoding/proto/proto_benchmark_test.go#L32",
		"https://go-mod-viewer.appspot.com/gopkg.in/chanxuehong/wechat.v1@v1.0.0-20171118020122-aad7e298d1e7/mch/sign.go#L36",
		"https://go-mod-viewer.appspot.com/gopkg.in/chanxuehong/wechat.v1@v1.0.0-20171118020122-aad7e298d1e7/mch/sign.go#L63",
		"https://go-mod-viewer.appspot.com/gopkg.in/dgrijalva/jwt-go.v3@v3.2.0/ecdsa.go#L135",
		"https://go-mod-viewer.appspot.com/gopkg.in/go-on/pq.v2@v2.0.0-20141218142246-0d009c09e638/encode.go#L342",
		"https://go-mod-viewer.appspot.com/k8s.io/apiserver@v0.31.2/pkg/storage/value/encrypt/envelope/envelope_test.go#L300",
		"https://go-mod-viewer.appspot.com/k8s.io/component-base@v0.31.2/metrics/buckets.go#L48",
		"https://go-mod-viewer.appspot.com/k8s.io/kubectl@v0.31.2/pkg/cmd/create/create_role.go#L119",
		"https://go-mod-viewer.appspot.com/kmodules.xyz/resource-metadata@v0.20.0/hub/registry.go#L419",
		"https://go-mod-viewer.appspot.com/kmodules.xyz/resource-metadata@v0.20.0/hub/registry.go#L430",
		"https://go-mod-viewer.appspot.com/knative.dev/eventing-contrib@v0.18.8/kafka/channel/pkg/reconciler/testing/kafkachannel.go#L150",
		"https://go-mod-viewer.appspot.com/knative.dev/eventing@v0.43.0/pkg/graph/lineage.go#L25",
		"https://go-mod-viewer.appspot.com/kusionstack.io/kusion@v0.13.0/pkg/engine/api/generate/run/run.go#L61",
		"https://go-mod-viewer.appspot.com/kusionstack.io/kusion@v0.13.0/pkg/util/pathutil/pathutil.go#L32",
		"https://go-mod-viewer.appspot.com/miniflux.app@v1.0.46/googlereader/handler.go#L825",
		"https://go-mod-viewer.appspot.com/modernc.org/ql@v1.4.7/plan.go#L2786",
		"https://go-mod-viewer.appspot.com/modernc.org/xc@v1.1.0/db.go#L151",
		"https://go-mod-viewer.appspot.com/mynewt.apache.org/newtmgr@v0.0.0-20240926144658-963e4b263a49/nmxact/nmserial/serial_xport.go#L253",
		"https://go-mod-viewer.appspot.com/open-match.dev/open-match@v1.8.1/examples/functions/golang/backfill/mmf/matchfunction.go#L229",
		"https://go-mod-viewer.appspot.com/open-match.dev/open-match@v1.8.1/testing/e2e/backfill_test.go#L168",
		"https://go-mod-viewer.appspot.com/oras.land/oras-go@v1.2.6/pkg/content/passthrough_test.go#L66",
		"https://go-mod-viewer.appspot.com/oss.terrastruct.com/d2@v0.6.7/lib/font/subsetFont.go#L778",
		"https://go-mod-viewer.appspot.com/oss.terrastruct.com/d2@v0.6.7/lib/font/subsetFont.go#L792",
		"https://go-mod-viewer.appspot.com/perkeep.org@v0.0.0-20240423032045-bb15e6eb48bc/pkg/index/indextest/tests.go#L1330",
		"https://go-mod-viewer.appspot.com/perun.network/go-perun@v0.11.0/wire/perunio/string_internal_test.go#L32",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/cluster-api-provider-aws/v2@v2.6.1/api/v1beta1/conversion_test.go#L45",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/cluster-api-provider-aws/v2@v2.6.1/api/v1beta1/conversion_test.go#L61",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/cluster-api-provider-aws/v2@v2.6.1/exp/controllers/rosamachinepool_controller.go#L520",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/cluster-api-provider-aws/v2@v2.6.1/exp/controllers/rosamachinepool_controller.go#L578",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/cluster-api-provider-azure@v1.17.0/exp/api/v1beta1/azuremachinepool_webhook_test.go#L628",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/e2e-framework@v0.5.0/pkg/env/env.go#L652",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/e2e-framework@v0.5.0/pkg/env/env.go#L660",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/external-dns@v0.15.0/provider/ovh/ovh.go#L253",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/kueue@v0.8.1/pkg/controller/jobframework/setup_test.go#L148",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/kueue@v0.8.1/pkg/webhooks/workload_webhook.go#L248",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/prow@v0.0.0-20241021132706-9efd512d94f7/pkg/plugins/override/override.go#L392",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/prow@v0.0.0-20241021132706-9efd512d94f7/pkg/plugins/verify-owners/verify-owners_test.go#L1395",
		"https://go-mod-viewer.appspot.com/sigs.k8s.io/prow@v0.0.0-20241021132706-9efd512d94f7/pkg/spyglass/lenses/lenses.go#L142",
		"https://go-mod-viewer.appspot.com/tractor.dev/toolkit-go@v0.0.0-20241010005851-214d91207d07/duplex/rpc/frame.go#L41",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/pool/multiplexed/multiplexed_test.go#L112",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/rpcz/id_generator_test.go#L95",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/rpcz/id_generator_test.go#L96",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/client_transport_stream_test.go#L129",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/example_test.go#L62",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_stream_test.go#L112",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_stream_test.go#L193",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_stream_test.go#L57",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L1002",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L121",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L173",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L328",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L377",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L74",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L759",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L800",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L847",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L938",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_test.go#L971",
		"https://go-mod-viewer.appspot.com/trpc.group/trpc-go/trpc-go@v1.0.3/transport/server_transport_udp_test.go#L56",
	}

	for _, url := range urls {
		resp, err := http.Get(url)
		if err != nil {
			fmt.Printf("can not download: %s, error is: %v\n", url, err)
			continue
		}
		defer resp.Body.Close()

		if resp.StatusCode != http.StatusOK {
			fmt.Printf("can not download: %s, status code: %d\n", url, resp.StatusCode)
			continue
		}
		...
		if err != nil {
			fmt.Printf("read file failed: %s, error: %v\n", url, err)
			continue
		}


		if strings.Contains(string(content), "binary.BigEndian") || strings.Contains(string(content), "binary.LittleEndian") {
			//	fmt.Printf("Contain binary.BigEndian or binary.LittleEndian: %s\n", url)
			//fmt.Printf("%s\n", url)
		} else {
			//fmt.Printf("Don't Contain binary.BigEndian or binary.LittleEndian:%s\n", url)
			fmt.Printf("%s\n", url)
		}
	}
}
